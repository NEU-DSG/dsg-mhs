...
// Load data.
const jqa_data = d3.json("/JQA-coReference/jqa_coef-network-ego.json").then(data => {
// const jqa_data = d3.json("/JQA-coReference/jqa_coef-network-subset.json").then(data => {
    // console.log(data);
    // update(data);
    buildNetwork(data);
})